            ...
            <nav class="flex-grow mt-4">
                ...
                <li class="relative">
                    ...
                    <ul id="dropdown-menu"
                        ...
                        <!-- Data Affiliate -->
                        <li class="rounded-md {{ Request::routeIs('dataaffiliate-admin', 'detaildata-affiliate') ? 'bg-midnight' : 'hover:bg-gray-200' }}">
                            <a href="{{ route('dataaffiliate-admin') }}" class="flex items-center gap-2 p-2 rounded-sm group
                                {{ Request::routeIs('dataaffiliate-admin', 'detaildata-affiliate') ? 'text-white' : 'text-gray-700' }}">
                ...
                <a href="{{ route('admin.news.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('news.index', 'news.create', 'news.show', 'news.edit') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('news.index', 'news.create', 'news.show', 'news.edit') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.bootcamp.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('bootcamp.index', 'bootcamp.create', 'bootcamp.show', 'bootcamp.edit') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('bootcamp.index', 'bootcamp.create', 'bootcamp.show', 'bootcamp.edit') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
