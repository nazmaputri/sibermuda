    ...
    <div class="flex h-screen" x-data="{ sidebarExpanded: true }">
        ...
        <div class="flex items-center justify-center space-x-5 md:justify-center mx-2 mt-6">
            ...
            <nav class="flex-grow mt-4">
                ...
                <a href="{{ route('admin.beranda') }}" class="block group">
                    <li class="flex items-center px-4 py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                            {{ Request::routeIs('admin.beranda') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            class="w-5 h-5 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                    {{ Request::routeIs('admin.beranda') ? 'text-white' : 'text-gray-700' }}">
                ...
                <li class="relative">
                    ...
                    <ul id="dropdown-menu"
                        ...
                        class="bg-white rounded-md shadow-lg ml-4 space-y-1 mt-2 p-2 transition-all duration-300 ease-in-out
                            {{ Request::routeIs('admin.data-mentor.index', 'admin.data-peserta.index', 'admin.data-mentor.show', 'admin.data-peserta.show') ? '' : 'hidden' }}">

                        <!-- Data Mentor -->
                        <li class="rounded-md {{ Request::routeIs('admin.data-mentor.index', 'admin.data-mentor.show') ? 'bg-midnight' : 'hover:bg-gray-200' }}">
                            <a href="{{ route('admin.data-mentor.index') }}" class="flex items-center gap-2 p-2 rounded-sm group
                                {{ Request::routeIs('admin.data-mentor.index', 'admin.data-mentor.show') ? 'text-white' : 'text-gray-700' }}">
                        ...
                        <!-- Data Peserta -->
                        <li class="rounded-md {{ Request::routeIs('admin.data-peserta.index', 'admin.data-peserta.show') ? 'bg-midnight' : 'hover:bg-gray-200' }}">
                            <a href="{{ route('admin.data-peserta.index') }}" class="flex items-center gap-2 p-2 rounded-sm group
                                {{ Request::routeIs('admin.data-peserta.index', 'admin.data-peserta.show') ? 'text-white' : 'text-gray-700' }}">
                        ...
                        <!-- Data Affiliate -->
                        <li class="rounded-md {{ Request::routeIs('admin.data-affiliate.index', 'admin.data-affiliate.show') ? 'bg-midnight' : 'hover:bg-gray-200' }}">
                            <a href="{{ route('admin.data-affiliate.index') }}" class="flex items-center gap-2 p-2 rounded-sm group
                                {{ Request::routeIs('admin.data-affiliate.index', 'admin.data-affiliate.show') ? 'text-white' : 'text-gray-700' }}">
                ...
                <a href="{{ route('admin.categories.index') }}" class="block group">
                    <li
                        ...
                        {{ Request::routeIs('admin.categories.index', 'admin.categories.create', 'admin.categories.show', 'admin.categories.edit', 'admin.detail-kursusadmin') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.categories.index', 'admin.categories.create', 'admin.categories.show', 'admin.categories.edit', 'admin.detail-kursusadmin') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.discount.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('admin.discount.index', 'admin.discount-tambah', 'admin.discount.edit') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.discount.index', 'admin.discount-tambah', 'admin.discount.edit') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span
                            ...
                            x-cloak
                            class="whitespace-nowrap transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                            {{ Request::routeIs('admin.discount.index', 'admin.discount.create', 'admin.discount.edit') ? 'text-white' : 'text-gray-700' }}">
                            Diskon
                        </span>
                    </li>
                </a>

                <a href="{{ route('admin.rating.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('admin.rating.index') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        <!-- Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.rating.index') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.news.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('admin.news.index', 'admin.news.create', 'admin.news.show', 'admin.news.edit') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.news.index', 'admin.news.create', 'admin.news.show', 'admin.news.edit') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.bootcamp.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                        {{ Request::routeIs('admin.bootcamp.index', 'admin.bootcamp.create', 'admin.bootcamp.show', 'admin.bootcamp.edit') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.bootcamp.index', 'admin.bootcamp.create', 'admin.bootcamp.show', 'admin.bootcamp.edit') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.laporan.index') }}" class="block group">
                    <li
                        class="flex items-center py-2 rounded-md space-x-4 transition-all duration-300 ease-in-out
                            {{ Request::routeIs('admin.laporan.index') ? 'bg-midnight' : 'hover:bg-gray-200' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        <!-- Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor"
                            class="w-5 h-5 shrink-0 transform transition-all duration-300 ease-in-out group-hover:translate-x-1
                                {{ Request::routeIs('admin.laporan.index') ? 'text-white' : 'text-gray-700' }}">
                            <path stroke-linecap="round" stroke-linejoin="round"
               ...
               <!-- Notifikasi -->
                ...
                <div id="dropdown" class="hidden absolute right-6 mt-10 md:mt-12 w-48 bg-white border rounded-lg shadow-lg z-10">
                    <ul class="py-1 space-y-1">
                        <li>
                            <a href="{{ route('admin.setting') }}" class="group group-hover:text-white block flex items-center p-1 text-sm text-gray-700 hover:bg-midnight rounded-md mx-2">
