        ...
        <div 
            ...
            <nav class="flex-grow mt-4">
                ...
                <a href="{{ route('welcome-mentor') }}" class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 border-[0.5px] border-primary-sidebar-hover {{ Request::routeIs('welcome-mentor') ? 'bg-primary-sidebar border-primary-sidebar' : 'hover:bg-primary-sidebar-hover' }}" :class="sidebarExpanded ? 'px-4' : 'px-1.5'">
                        <svg class="w-5 h-5 md:block text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <span 
                            ...
                            x-transition
                            x-cloak
                            class="whitespace-nowrap text-white">Dashboard</span>
                    </li>
                </a>

                <a href="{{ route('courses.index') }}" class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 border-[0.5px] border-primary-sidebar-hover {{ Request::routeIs('courses.index', 'courses.show', 'courses.edit', 'courses.create', 'materi.show', 'materi.create', 'materi.edit', 'quiz.show', 'quiz.create', 'quiz.edit', 'chat-mentor') ? 'bg-primary-sidebar border-primary-sidebar' : 'hover:bg-primary-sidebar-hover' }}" :class="sidebarExpanded ? 'px-4' : 'px-1.5'">
                        <img width="20" height="20" src="https://img.icons8.com/ios-filled/50/courses.png" alt="courses" class="filter invert"/>
                        <span 
                            x-show="sidebarExpanded"
                            x-transition
                            x-cloak
                            class="whitespace-nowrap text-white">Kursus</span>
                    </li>
                </a>
