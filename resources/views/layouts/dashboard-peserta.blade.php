...
<x-loading-screen />
    ...
    <div class="flex h-screen" x-data="{ sidebarExpanded: true }">
        ...
        <div class="flex items-center justify-center space-x-5 md:justify-center mx-2 mt-6">
            ...
            <nav class="flex-grow mt-4">
                ...
                <a href="{{ route('kategori-peserta') }}" class="block">
                    ...
                    >
                        ...
                        <span x-show="sidebarExpanded" x-transition x-cloak class="whitespace-nowrap text-gray-700 {{ Request::routeIs('kategori-peserta', 'categories-detail', 'kursus-peserta') ? 'text-white' : 'text-gray-700' }}">Kursus</span>
                    </li>
                </a>
            ...
            <div class="m-4">
                <a href="https://wa.me/62895365544316" target="_blank" class="block">
                    <li 
                        class="flex items-center py-2 rounded-md space-x-4 text-green-700 bg-green-200" 
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-green-700"  height="100" viewBox="0 0 50 50" fill="currentColor">
                        ...
                        <span x-show="sidebarExpanded" x-transition x-cloak class="whitespace-nowrap">Whatsapp</span>
                    </li>
                </a>
            </div>
