...
<x-loading-screen />
    ...
    <div class="flex h-screen" x-data="{ sidebarExpanded: true }">
        ...
        <!-- Sidebar -->
        <div 
            class="fixed z-50 inset-y-0 left-0 bg-primary shadow-lg transition-all duration-300 ease-in-out 
            lg:static lg:translate-x-0 flex flex-col justify-between"
            :class="{
        ...
        <div class="flex items-center justify-center space-x-5 md:justify-center mx-2 mt-6">
            ...
            <!-- <button 
                ...
                class="lg:hidden p-1 rounded-md bg-sky-100 text-red-700">
            ...
            <nav class="flex-grow mt-4">
                <ul class="ml-4 mr-4 mt-5 space-y-2 text-gray-800">
                    
                <a href="{{ route('welcome-peserta') }}" class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 border-[0.5px] border-primary-sidebar-hover {{ Request::routeIs('welcome-peserta') ? 'bg-primary-sidebar border-primary-sidebar' : 'hover:bg-primary-sidebar-hover' }}" :class="sidebarExpanded ? 'px-4' : 'px-1.5'">
                        <!-- Icon SELALU tampil -->
                        <svg class="w-5 h-5 shrink-0 text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <a href="{{ route('kategori-peserta') }}" class="block">
                    <li 
                        class="flex items-center py-2 rounded-xl space-x-4 border-[0.5px] border-primary-sidebar-hover {{ Request::routeIs('kategori-peserta', 'categories-detail', 'kursus-peserta') ? 'bg-primary-sidebar border-primary-sidebar' : 'hover:bg-primary-sidebar-hover' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        <svg class="w-5 h-5 shrink-0 text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path d="M40 48C26.7 48 16 58.7 16 72l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24L40 48zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L192 64zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zM16 232l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0z"/>
                        </svg>
                        <span x-show="sidebarExpanded" x-transition x-cloak class="whitespace-nowrap text-white">Kategori</span>
                    </li>
                </a>

                <a href="{{ route('daftar-kursus') }}" class="block">
                    <li 
                        class="flex items-center py-2 rounded-xl space-x-4 border-[0.5px] border-primary-sidebar-hover {{ Request::routeIs('daftar-kursus', 'detail-kursus', 'study-peserta', 'chat.student', 'quiz.show', 'quiz.result') ? 'bg-primary-sidebar border-primary-sidebar' : 'hover:bg-primary-sidebar-hover' }}"
                        :class="sidebarExpanded ? 'px-4' : 'px-1.5'"
                    >
                        <svg class="w-5 h-5 shrink-0 text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <span x-show="sidebarExpanded" x-transition x-cloak class="whitespace-nowrap text-white">Belajar</span>
                    </li>
                </a>
            ...
            <div class="bottom-10 mb-16 text-center">
                <!-- Tombol toggle untuk membuka tutup sidebar -->
                <button 
                    @click="sidebarExpanded = !sidebarExpanded" 
                    class="p-1.5 bg-white text-gray-700 rounded-full">
