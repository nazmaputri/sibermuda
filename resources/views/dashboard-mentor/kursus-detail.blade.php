...
@if (! in_array($namaKategori, ['cyber security', 'siber', 'cybersecurity', 'Cyber Security', 'CyberSecurity', 'Cybersecurity']))
...
@if(in_array($catName, ['cyber security', 'siber', 'cybersecurity', 'Cyber Security', 'CyberSecurity', 'Cybersecurity']))
    <!-- Section Tugas Akhir -->
