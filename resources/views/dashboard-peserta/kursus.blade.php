    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-md p-6 mb-3">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="border rounded-lg p-4 shadow-md bg-white flex flex-col">
                    ...
                    <div class="flex justify-between items-center mt-auto gap-x-3 flex-nowrap overflow-x-auto">
                        ...
                        <a href="{{ route('detail-kursus', $course->id) }}" 
                            class="bg-white border border-sky-300 text-sky-500 px-2 py-2 rounded-lg hover:bg-sky-300 hover:text-white flex items-center space-x-1 group w-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-3 h-3 hidden sm:block">
                                <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z" clip-rule="evenodd" />
                            </svg>
                            <span class="text-sm block">Detail</span>
                        </a>

                        <!-- Button Belajar -->
                        <a href="{{ route('study-peserta', ['id' => $course->id]) }}" 
                            class="bg-white border border-yellow-300 text-yellow-500 px-2 py-2 rounded-lg hover:bg-yellow-300 hover:text-white flex items-center space-x-1 group w-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-3 h-3 hidden sm:block fill-current text-yellow-500 group-hover:text-white">
                            ...
                            <span class="text-sm block">Belajar</span>
                        </a>
                        ...
                        <a href="{{ route('chat.start', ['courseId' => $course->id]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" 
                                class="w-3 h-3 hidden sm:block fill-current 
                            ...
                            <span class="text-sm block {{ $course->isChatActive ? 'text-green-500 group-hover:text-white' : 'text-gray-500' }}">Chat</span>
                        </a>
                    </div>                    
                </div>
            @empty
            <div class="col-span-full text-center items-center justify-center flex flex-col">
                ...
                <p class="text-gray-600 text-center text-sm">Anda belum membeli kursus apapun.</p>
            </div>
            @endforelse
        </div>
    </div>
