...
<div class="max-w-2xl mx-auto border border-gray-200 bg-white p-6 rounded-lg shadow-lg">
    ...
    <form action="{{ url('/settings') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4 relative">
            <label for="new_password" class="block font-medium text-gray-700">Kata Sandi Baru</label>
            
            <div class="relative">
                <input type="password" name="new_password" id="new_password"
                    class="password-input p-2 pr-10 mt-1 block w-full text-sm text-gray-700 border-gray-200 border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400" placeholder="Masukkan kata sandi">
