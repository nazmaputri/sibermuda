...
<div class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
    ...
    <div class="mt-10">
        ...
        <div class="mt-8">
            <!-- ====================== 
                 Bagian Tugas Akhir di-comment dulu
            ====================== -->
            <!--
            @if($isCyber)
                ...
                @if(empty($course->finalTask))
                    <div class="col-span-full text-center items-center justify-center flex flex-col">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                             stroke-width="1.5" stroke="currentColor" class="size-5 mb-1 text-gray-600">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="m20.25 7.5-.625 10.632a2.25 2.25 0 
                                  0 1-2.247 2.118H6.622a2.25 2.25 0 
                                  0 1-2.247-2.118L3.75 7.5m6 
                                  4.125 2.25 2.25m0 0 2.25 
                                  2.25M12 13.875l2.25-2.25M12 
                                  13.875l-2.25 2.25M3.375 
                                  7.5h17.25c.621 0 
                                  1.125-.504 1.125-1.125v-1.5c0-.621-.504-
                                  1.125-1.125-1.125H3.375c-.621 
                                  0-1.125.504-1.125 
                                  1.125v1.5c0 .621.504 
                                  1.125 1.125 1.125Z" />
                        </svg>
                ...
                @else
                    <div x-data="{ open: false }" class="bg-white p-2.5 rounded-lg shadow-sm border border-gray-200">
                        <div @click="open = !open" class="flex justify-between items-center cursor-pointer">
                            <span class="text-gray-700 text-sm font-semibold mr-2">01.</span>
                            <span class="flex-1 text-sm font-semibold text-gray-700 capitalize">
                                {{ $course->finalTask->judul }}
                            </span>
                        ...
                        <div x-show="open" x-transition class="mt-3 text-sm text-gray-700">
                            <p><span class="font-semibold">Deskripsi:</span>
                                {{ $course->finalTask->desc ?: 'Tidak ada deskripsi' }}
                            </p>
                        </div>
                    </div>
                @endif
            ...
            @if($course->quizzes->isEmpty())
                <div class="col-span-full text-center items-center justify-center flex flex-col">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
                         ...
                         stroke="currentColor" class="size-5 mb-1 text-gray-600">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="m20.25 7.5-.625 10.632a2.25 
                              2.25 0 0 1-2.247 2.118H6.622a2.25 
                              2.25 0 0 1-2.247-2.118L3.75 
                              7.5m6 4.125 2.25 2.25m0 0 
                              2.25 2.25M12 13.875l2.25-
                              2.25M12 13.875l-2.25 
                              2.25M3.375 7.5h17.25c.621 
                              0 1.125-.504 1.125-1.125v-1.5c0-.621-
                              .504-1.125-1.125-1.125H3.375c-.621 
                              0-1.125.504-1.125 
                              1.125v1.5c0 .621.504 
                              1.125 1.125 1.125Z" />
                    </svg>
