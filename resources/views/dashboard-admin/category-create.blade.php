    ...
    <div class="bg-white shadow-md rounded-lg p-6 border border-gray-200">
        ...
        <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex justify-end space-x-2">
                <a href="{{ route('categories.index') }}" class="bg-red-400 hover:bg-red-300 text-white py-2 px-4 rounded-md">
                    Batal
                </a>
                <button type="submit" class="bg-sky-400 hover:bg-sky-300 text-white py-2 px-4 rounded-md">
                    Tambah 
                </button>
            </div>
        </form>
