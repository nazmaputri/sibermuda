...
<div class="container mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 mb-4">
            <form action="{{ route('dataaffiliate-admin') }}" method="GET" class="w-full md:max-w-xs">
            ...
            <a href="{{ route('tambah-affiliate') }}"  class="ml-4 text-white px-4 py-2 font-semibold rounded-md shadow-blue-100 bg-blue-400 hover:bg-blue-300 focus:outline-none flex items-center">
