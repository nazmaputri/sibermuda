...
<div class="flex justify-start mb-2">
    <a href="{{ route('dataaffiliate-admin') }}" class="text-midnight font-semibold p-1 bg-white border border-gray-200 rounded-full transition-transform duration-300 ease-in-out transform hover:scale-105 inline-flex items-center">
...
<div class="container mx-auto">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 mb-6 border border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            <!-- Kolom Tengah: Informasi affiliate -->
            ...
            <div class="min-w-full w-64">
                <table class="min-w-full text-sm border-separate border-spacing-0">
                    ...
                    <tbody class="text-gray-600 text-sm">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-gray-500 py-2 border-b border-l border-r border-gray-200">Belum ada kursus yang diajarkan oleh affiliate ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
