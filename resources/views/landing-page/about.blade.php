...
<head>
    ...
    <title>Tentang Kami - Sibermuda: Platform Kursus Online</title>

    <meta property="og:title" content="Tentang Kami - Sibermuda: Platform Kursus Online">
        ...
        <div class="bg-white rounded-2xl p-2 text-left flex flex-col md:flex-row h-auto">
            ...
            <div class="md:w-2/3 w-full flex flex-col justify-center md:pl-6">
                ...
                <p class="text-gray-600 text-md">
                 Kak Rama Ahmad adalah pakar cyber security dengan karier gemilang yang juga mendirikan Sibermuda, platform edukasi yang telah melatih ribuan talenta lokal melalui pelatihan, sertifikasi, dan program peningkatan kesadaran keamanan digital di Indonesia.
                </p>
    ...
    <div>
        <div class="bg-white rounded-2xl p-2 text-left flex flex-col md:flex-row-reverse h-auto">
            ...
            <div class="md:w-1/3 w-full md:pl-4 mb-4 md:mb-0">
                <div class="relative group rounded-xl overflow-hidden w-full h-64 md:h-full">
                    <!-- Gambar -->
                    <img src="{{ asset('storage/paki.png') }}" alt="Mentor Profile" class="w-full h-full object-cover rounded-xl transition duration-300">
    ...
    <div>
        <div class="bg-white rounded-2xl p-2 text-left flex flex-col md:flex-row h-auto">
            ...
            <div class="md:w-1/3 w-full md:pl-4 mb-4 md:mb-0">
                <div class="relative group rounded-xl overflow-hidden w-full h-64 md:h-full">
                    <!-- Gambar -->
                    <img src="{{ asset('storage/budel.png') }}" alt="Mentor Profile" class="w-full h-full object-cover rounded-xl transition duration-300">
          ...
          <div class="bg-white rounded-2xl shadow-lg border border-gray-200 h-[320px] p-4 text-center relative">
            ...
            <div class="absolute bottom-0 left-0 right-0 bg-white border-t-2 border-gray-200 py-4 px-4">
              <h3 class="text-md font-semibold text-gray-700">{{ $m->name }}</h3>
                ...
                @php
                  // Ambil hanya courses yang status-nya 'approved'
                  $approvedCourses = $m->courses->where('status', 'approved', 'published');
                @endphp

                @if($approvedCourses->count() === 1)
                  <p class="text-sm text-gray-500 italic mt-1">
                    <strong>Mentor of</strong> {{ $approvedCourses->first()->title }}
                  </p>
                @elseif($approvedCourses->count() > 1)
                  ...
                  <script>
                    document.addEventListener('DOMContentLoaded', function () {
                      const courses{{ $index }} = {!! json_encode($approvedCourses->pluck('title')) !!};
                ...
                @else
                  <p class="text-sm text-gray-400 italic mt-1">Belum ada kursus yang ditambahkan </p>
                @endif
            </div>
          </div>
        </div>
