...
@section('title', 'Pengaturan Akun superadmin')
@section('content')
...
<div class="max-w-2xl mx-auto border border-gray-200 bg-white p-6 rounded-lg shadow-lg">
    ...
    <form action="{{ url('/settings-admin/update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            @else
                <img src="{{ asset('storage/default-profile.jpg') }}" alt="Foto Default" class="w-28 h-28 rounded-full mt-2 mx-auto">
            @endif
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name"
                ...
                class="p-2 mt-1 text-sm text-gray-700 block w-full border border-gray-200 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400" placeholder="Masukkan nama">
            @error('name')
                <p class="text-red-500 text-xs">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" id="email"
                ...
                class="p-2 mt-1 text-sm text-gray-700 block w-full border border-gray-200 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400" placeholder="Masukkan email">
            @error('email')
                <p class="text-red-500 text-xs">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="flex items-center p-3 mb-2 text-sm text-yellow-600 rounded-lg bg-yellow-100 md:mt-3 mt-2" role="alert">
                ...
                <p class="text-xs text-yellow-800">Gunakan format internasional tanpa angka 0 di awal, misalnya <strong>0812</strong> jadi <strong>62812</strong> agar bisa diarahkan ke WhatsApp.</p>
            </div>
            @error('phone_number')
       ...
       <div class="mb-3 relative">
        ...
        <div class="flex justify-end space-x-4 mt-2">
            <a href="{{ route('welcome-superadmin') }}" class="bg-red-400 text-white font-medium py-2 px-6 rounded-md hover:bg-red-300 mt-2">Batal</a>
