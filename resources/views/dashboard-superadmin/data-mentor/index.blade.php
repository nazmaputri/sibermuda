...
<div class="container mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 mb-4">
            <form action="{{ route('datamentor-superadmin') }}" method="GET" class="w-full md:max-w-xs">
            ...
            <a href="{{ route('tambah-mentor-superadmin') }}"  class="ml-4 text-white px-4 py-2 font-semibold rounded-md shadow-blue-100 bg-blue-400 hover:bg-blue-300 focus:outline-none flex items-center">
                        ...
                        <tr class="bg-white hover:bg-gray-50 user-row" data-role="{{ $user->role }}">
                            ...
                            <td class="py-3 px-6 text-center border-b border-r border-gray-200">
                                <div class="flex items-center justify-center space-x-8">
                                    ...
                                    <!-- Tombol Lihat Detail -->
                                    <a href="{{ route('detaildata-mentor-superadmin', ['id' => $user->id]) }}" class="text-white bg-sky-300 p-1 rounded-md hover:bg-sky-200" title="Lihat">
