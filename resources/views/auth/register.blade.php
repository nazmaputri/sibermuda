...
<x-loading-screen />
    ...
    <div class="hidden md:flex md:w-1/2 bg-midnight rounded rounded-2xl items-center justify-center">
        ...
        <div class="w-full md:w-1/2 p-4">
            ...
            <h4 class="text-center text-gray-700">Klik disini untuk daftar sebagai mentor!<a href="register-mentor" class="text-midnight font-semibold ml-1 hover:underline">Daftar</a></h4>
            <!-- Form -->
            <form action="{{ route('register') }}" method="POST" class="space-y-4" id="form">
                @csrf

                    <!-- Name Field (Dengan efek floating label) -->
                    <div class="relative w-full mb-4">
                        <input 
                            ...
                            value="{{ old('name') }}" 
                            placeholder=" " 
                            class="peer w-full px-4 pt-5 pb-2 text-sm bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-700 focus:border-gray-700 
