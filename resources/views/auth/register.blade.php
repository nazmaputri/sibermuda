...
<x-loading-screen />
    ...
    <div class="flex justify-center items-center min-h-screen px-4 py-2">
        ...
        <div class="w-full space-y-2">
            ...
            <h4 class="text-center text-gray-700">Klik disini untuk daftar sebagai mentor!<a href="register-mentor" class="text-gray-700 underline ml-1">Daftar</a></h4>
            <!-- Form -->
            <form action="{{ route('register') }}" method="POST" class="space-y-4" id="form">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="relative order-4 md:order-3">
                        ...
                        <span class="absolute top-1/2 -translate-y-1/2 mt-3 right-3 cursor-pointer text-gray-500" id="togglePassword">
