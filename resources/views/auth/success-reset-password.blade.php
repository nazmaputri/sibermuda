...
<head>
    ...
    <title>Sukses Send Lupa Password</title>
...
<body class="bg-white min-h-screen flex items-center justify-center">
    <div class="w-full max-w-6xl bg-white rounded-xl overflow-hidden items-center justify-center" data-aos="zoom-in">
            ...
            <div class="flex items-center justify-center">
                <img src="{{ asset('storage/reset-password.png') }}" alt="Logo" class="w-60 h-60 object-cover transform transition-transform hover:scale-105">
            </div>
            <div class="w-full p-4">
                <h1 class="text-3xl font-semibold text-midnight mb-2 text-center">Reset Kata Sandi Berhasil!</h1>
                <p class="text-gray-700 text-sm md:text-md text-center">Silahkan login dengan password yang baru</p>
                <div class="mt-4 flex items-center justify-center">
                    <button class="flex items-center justify-center space-x-1 p-2 bg-midnight rounded-md group">
                        ...
                        <a href="{{ route('login') }}" class="text-sm text-white hover:underline pr-1">Login</a>
                    </button>
                </div>
            </div> 
    </div>
